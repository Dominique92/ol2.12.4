...
OpenLayers.Layer.SwissTopo = OpenLayers.Class(OpenLayers.Layer.WMTS, {
     ...
     * {String} list of parameters to display the attribution of the layer
     */
	attribution: {
		name: 'SwissTopo',
	 ...
	 * Tha capabilities are defined in http://wmts.geo.admin.ch/1.0.0/WMTSCapabilities.xml
	 * To save time, they are simulated
	 * If they change, we must update the following
     *
     * Returns:
