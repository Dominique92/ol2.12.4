...
//<<DCM  infobules de l'éditeur de traces
	...
	'DeleteFeature': "Supprimer une trace: Cliquer sur la trace puis accepter",
	'CutFeature': "Supprimer un sommet: Cliquer sur la trace puis sur le sommet à supprimer\n\n"+
		"Couper une trace en 2: Cliquer sur la trace puis sur le milieu du segment à supprimer",
	'CutFeatureSplit': "Couper une trace en 2: Cliquer sur la trace puis sur le milieu du segment à supprimer",
	'CutFeatureSummit': "Supprimer un sommet: Cliquer sur la trace puis sur le sommet à supprimer",
	'ModifyFeature': "Déplacer un sommet: Cliquer sur la trace, cliquer sur le sommet, maintenir et faire glisser\n\n"+
		"Ajouter un sommet à une trace: Cliquer sur la trace, cliquer et faire glisser le milieu d un segment\n\n"+
		"Supprimer un sommet d une trace: Cliquer sur la trace, survoler le sommet à supprimer et appuyer sur D",
	'DrawFeaturePath': "Ajouter une trace: Cliquer à l'emplacement du début, sur chaque point intermédiaire, double cliquer à la fin\n\n"+
		"Etendre une trace: Cliquer sur une extrémité, sur chaque point intermédiaire, double cliquer à la fin\n\n"+
		"Joindre deux traces: Cliquer sur une extrémité, double cliquer sur l'autre",
